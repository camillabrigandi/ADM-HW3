...
#####################################################################
#manually add the colnames since we don't have them in the tsv files#
#####################################################################
sed -i '1i courseName\tuniversityName\tfacultyName\tisItFullTime\tdescription\tstartDate\tfees\tmodality\tduration\tcity\tcountry\tadministration\turl' merged_courses.tsv
